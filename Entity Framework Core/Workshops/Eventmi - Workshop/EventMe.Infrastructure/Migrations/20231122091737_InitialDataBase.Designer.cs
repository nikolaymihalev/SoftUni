...
namespace EventMe.Infrastructure.Migrations
{
    ...
    [Migration("20231122091737_InitialDataBase")]
            ...
            modelBuilder.Entity("EventMe.Infrastructure.Data.Models.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasComment("Индентификатор на мястото");
                    ...
                    b.Property<int>("TownId")
                        .HasColumnType("int")
                        .HasComment("Индентификатор на града");
            ...
            modelBuilder.Entity("EventMe.Infrastructure.Data.Models.Event", b =>
                {
                    ...
                    b.Property<int>("PlaceId")
                        .HasColumnType("int")
                        .HasComment("Индефикатор на мястото");
            ...
            modelBuilder.Entity("EventMe.Infrastructure.Data.Models.Town", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasComment("Индентификатор на град");
